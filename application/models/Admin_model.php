...
class Admin_model extends CI_Model {
    ...
    function insert_user($postData){
        ...
        if($validate){
            ...
            $message = "Ini Detail Akun Anda:<br><br>Email: ".$postData['email']."<br>Password Anda: ".$password."<br>Silahkan Ganti Password Anda Setelah Login.<br><br> Anda Bisa Login Di ".base_url().".";
    ...
    function send_email($message,$subject,$sendTo){
        ...
        try
        {
            ...
            $hello = '<h1 style="color:#333;font-family:Helvetica,Arial,sans-serif;font-weight:300;padding:0;margin:10px 0 25px;text-align:center;line-height:1;word-break:normal;font-size:38px;letter-spacing:-1px">Hallo, &#9786;</h1>';
            $thanks = "<br><br><i>Akun Ini Untuk Notifikasi, Mohon Tida Reply Ke Akun Ini.</i><br/><br/>Thanks,<br/>Admin<br/><br/>";
